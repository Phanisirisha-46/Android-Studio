...
import com.example.recyclerviewexp4.Department;
import com.example.recyclerviewexp4.DepartmentViewHolder;
...
public class DepartmentAdapter extends RecyclerView.Adapter<DepartmentViewHolder> {
    ...
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DepartmentViewHolder(LayoutInflater.from(ct).inflate(R.layout.llayout,parent));
    }
